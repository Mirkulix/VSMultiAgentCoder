...
exports.ModelFarmViewProvider = void 0;
/**
 * CodeTeam AI Ultra - Model Farm Settings Webview
 * Interactive UI for managing providers and models
 */
const vscode = __importStar(require("vscode"));
class ModelFarmViewProvider {
    extensionUri;
    static viewType = 'codeteam.modelFarm';
    _view;
    modelFarm;
    constructor(extensionUri, modelFarm) {
    ...
    async testProviderWithProgress(providerId) {
        if (!this._view)
            return;
        this._view.webview.postMessage({ type: 'testingStart', providerId });
        const result = await this.modelFarm.testProvider(providerId);
...
exports.ModelFarmViewProvider = ModelFarmViewProvider;
//# sourceMappingURL=model-farm-view.js.map